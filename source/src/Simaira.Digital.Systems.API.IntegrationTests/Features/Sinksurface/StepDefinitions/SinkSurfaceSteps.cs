namespace Simaira.Digital.Systems.IntegrationTests.Features.Landing.StepDefinitions
{
    using System;
    ...
    [Binding]
    public class SinkSurfaceSteps : BaseSteps
    {
        public SinkSurfaceSteps(IEcolabCustomerPortalClientFactory customerPortalClientFactory, ScenarioContext scenarioContext, Endpoints endpoints)
            : base(customerPortalClientFactory, scenarioContext, endpoints)
        {
        }


        [Given(@"Get aligned CDM Sites and Accounts for '(.*)' from CDM API")]
        ...
        public void CraeteSinkSurfaceOverallPerformancePayload()
        {
        ...
        [Then(@"Get Sink Surface Overall Performance for Pulse Check '(.*)'")]
        public async Task GetSinkSurfaceOverallPerformanceAsync(bool isPulseCheck)
        {
